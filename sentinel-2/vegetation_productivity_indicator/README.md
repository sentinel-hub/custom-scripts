...
- [EO Browser](https://apps.sentinel-hub.com/eo-browser/?zoom=12&lat=38.03065&lng=-100.30312&themeId=DEFAULT-THEME&datasetId=S2L1C&fromTime=2015-06-01T00:00:00.000Z&toTime=2020-06-01T00:00:00.000Z&visualizationUrl=https%3A%2F%2Fservices.sentinel-hub.com%2Fogc%2Fwms%2F42924c6c-257a-4d04-9b8e-36387513a99c&evalscripturl=https%3A%2F%2Fraw.githubusercontent.com%2Fsentinel-hub%2Fcustom-scripts%2Fmaster%2Fsentinel-2%2Fvegetation_productivity_indicator%2Fscript.js){:target="_blank"}
...
Sentinel Hub RESTful API (<a href="script_view2" id='togglescript'>click</a> to expand).
<div id='script_view2' style="display:none">
{% highlight json %}
      {% include_relative curl.txt %}
{% endhighlight %}
</div>

Save script.js to your current directory and run the command above.
...
```
<a href="#" id='togglescript'>Example response</a>.
<div id='script_view' style="display:none">
{% highlight json %}
      {% include_relative response.txt %}
{% endhighlight %}
</div>
