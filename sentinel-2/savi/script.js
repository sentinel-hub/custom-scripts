...
if (index <-1) return [0,0,0]; // black color for values less than -1
else if (index <0) return [0.69,0.88,0.901]; // blue color majorly water
else if (index <0.09) return [0.74,0.72,0.42];  // yellow
...
else if (index <1)   return [0.23,0.70,0.44]; // green
else return [1,1,1];
...
(index,	            //  specify the index
     [ 0,0.1, 0.6, 1], //  specify the borders
