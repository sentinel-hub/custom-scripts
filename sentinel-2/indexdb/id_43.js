...
// URL https://www.indexdatabase.de/db/si-single.php?sensor_id=96&rsindex_id=43
//

let index = 1.5 * (2.5 * (B08 - B04) - 1.3 * (B08 - B03)) / Math.sqrt(Math.pow((2.0 * B08 + 1.0), 2.0) - (6.0 * B08 - 5.0 * Math.sqrt(B04)) - 0.5);
let min = -0.598;
let max = 1.032;
let zero = 0.0;
