...
// URL https://www.indexdatabase.de/db/si-single.php?sensor_id=96&rsindex_id=209
//

let index = 1.22 * (B08 - 1.22 * B04 - 0.03) / (1.22 * B08 + B04 - 1.22 * 0.03 + 0.08 * (1.0 + Math.pow(1.22, 2.0)));
let min = -0.971;
let max = 0.575;
let zero = 0.0;
