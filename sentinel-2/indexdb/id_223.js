// Normalized Difference NIR/Rededge Normalized Difference Red-Edge
// URL http://www.indexdatabase.de/db/si-single.php?rsindex_id=223=&sensor_id=96

let index = (B09-B05)/(B09+B05);
let min = -0.89;
let max = 0.891;
let zero = 0.0;
