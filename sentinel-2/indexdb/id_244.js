...
// URL http://www.indexdatabase.de/db/si-single.php?rsindex_id=244=&sensor_id=96

let index = (((B05-B03)/(B05+B03))+0.5)/(Math.abs(((B05-B03)/(B05+B03))+0.5))*Math.sqrt(Math.abs((((B05-B03)/(B05+B03)))+0.5));
let min = -0.624;
let max = 1.179;
let zero = 0.0;
