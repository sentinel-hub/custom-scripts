...
Making contour lines very thick makes and returning them in a color, in this case white, while returning everything else with a color visualization, gives the impression of colored contour lines on a white background. 
