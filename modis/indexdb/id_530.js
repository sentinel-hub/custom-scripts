// Normalized Difference 550/530 Physiological reflectance index
// URL http://www.indexdatabase.de/db/si-single.php?rsindex_id=530=&sensor_id=14

let index = (B12-B11)/(B12+B11);
let min = -0.889;
let max = 0.89;
let zero = 0.0;
