...
![A3](fig/fig3.jpg)
In this image, only areas with an VMI3 index range of 0.0 to -1 are visualized in a continuous color scale, displaying water areas in blue colors. The water levels of Lake Urmia and Sefidrud Dam in Gilan province are well visible.
